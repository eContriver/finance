...
def parse_args(default_cache_dir: str, default_output_dir: str, default_config_file: str):
    parser = argparse.ArgumentParser(prog='alert', formatter_class=argparse.ArgumentDefaultsHelpFormatter)
...
if __name__ == "__main__":
    locations = Locations()
    input_config_path = os.path.join(locations.get_parent_user_dir(), 'alert.yaml')
