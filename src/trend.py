...
from main.runners.trend_runner import TrendRunner


def parse_args(default_cache_dir: str, default_output_dir: str, default_config_file: str):
    parser = argparse.ArgumentParser(prog='trend', formatter_class=argparse.ArgumentDefaultsHelpFormatter)
...
if __name__ == "__main__":
    locations = Locations()
    input_config_path = os.path.join(locations.get_parent_user_dir(), 'trend.yaml')
