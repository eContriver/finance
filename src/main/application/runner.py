...
def prepare_run(locations: Locations, debug: bool, profile: bool):
...
def finish_run(run_start: datetime, profile: bool):
...
class Runner(metaclass=ABCMeta):
    ...
    def get_run_name(self) -> str:
        """
        This method should implement an algorithm that calculates and returns the run's name. This is used for reports
        etc.
        :return:
        """
        pass
...
def get_adapter_class(class_name: str) -> Type:
    ...
    :param class_name: The string representation of the class (e.g. AlphaVantage)
